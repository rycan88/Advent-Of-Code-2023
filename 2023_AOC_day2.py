inp = '''Game 1: 1 blue; 4 green, 5 blue; 11 red, 3 blue, 11 green; 1 red, 10 green, 4 blue; 17 red, 12 green, 7 blue; 3 blue, 19 green, 15 red
...
for n, line in enumerate(L):
    start = line.index(":") + 2
    Box = line[start:].split("; ")
    valid = True
    for sets in Box:
        if isValidSet(sets) == False:
            valid = False
    if valid:
        total += (n + 1)
print(total)
